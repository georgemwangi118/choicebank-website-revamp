...
export default function AdminJobActions({ id }: { id: string }) {
  ...
  return (
    <div className="flex items-center gap-2 justify-end">
      <Link href={`/admin/jobs/${id}/edit`} className="p-1.5 rounded-lg text-gray-400 hover:text-[#0A0534] hover:bg-gray-100 transition-colors">
        <EditIcon />
      </Link>
